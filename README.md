...
| `SANITY_CHECKS`             | may be used to minimize the size of the library, however, when possible, it is recommended that sanity checks be included during the application development process. When set to true checking code is included | false |
