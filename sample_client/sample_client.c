...
struct ap_scan aps[] = /* clang-format off */ 
                    { { "283B8264E08B", 300, 3660, -8 },
                      ...
                      { "283B823629F0", 300, 3662, -90 },
                      { "283B821C712A", 300, 3660, -77 },
                      { "0024D2E08E5D", 300, 3662, -92 },
                      { "283B821CC232", 300, 3660, -91 },
                      { "74DADA5E1015", 300, 3662, -88 },
                      { "FC75164E9CA2", 300, 3660, -88 },
                      { "B482FEA46221", 300, 3662, -89 },
...
int main(int argc, char *argv[])
{
    ...
    printf("Skyhook location: status: %s, lat: %.6f, lon: %.6f, hpe: %d, source: %d\n",
        sky_pserver_status(loc.location_status), loc.lat, loc.lon, loc.hpe, loc.location_source);
