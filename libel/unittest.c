...
Sky_ctx_t *_test_sky_ctx() {
    ...
    uint8_t _aes_key[AES_KEYLEN] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
    uint32_t bufsize;

    if (sky_open(&_ctx_errno, (uint8_t *)TEST_DEVICE_ID, 6, TEST_PARTNER_ID, _aes_key, NULL, SKY_LOG_LEVEL_DEBUG, _test_log, NULL, NULL) == SKY_ERROR) {
